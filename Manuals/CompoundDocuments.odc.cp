...
A selection can be cut to the Windows clip board by typing Cntrl + X or copied to the clip board by typing Cntrl + C. The contents of the clip board can be inserted at the current caret position by typing Cntl + V. These three operations can also be performed using options in the Edit menu.
