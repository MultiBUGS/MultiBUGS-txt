...
MODULE PharmacoPKZOlag2ss;
	...
	PROCEDURE Value (params, scalars: GraphNodes.Vector): REAL;
		VAR
			...
			A, s, dose, omega, Tlag, TI, value: REAL;
		...
		BEGIN
			...
			END;
			RETURN dose * (C1 + C2) / (TI * Math.Exp(logV1))
		END ProfileSS;
	...
	BEGIN
		install := "PharmacoPKZOlag2ss.Install"
	END Install;
	...
	BEGIN
		install := "PharmacoPKZOlag2ss.MemInstall"
	END Install;
