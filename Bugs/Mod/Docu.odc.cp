...
MODULE BugsDocu;
	...
	PROCEDURE PrintExamplesVolII*;
		VAR
			...
			loc, tempLoc: Files.Locator;
			par: Printing.Par;
			examples: ARRAY 18 OF ARRAY 64 OF CHAR;
			i, num: INTEGER;
			first: BOOLEAN;
	BEGIN
		par := Printing.NewDefaultPar("");
	...
	BEGIN
		...
		END;
		examples[0] := "Camel";
		examples[1] := "Eye-tracking";
		examples[2] := "Funshapes";
		examples[3] := "Hepatitis";
		examples[4] := "Hips1";
		examples[5] := "Hips2";
		examples[6] := "Hips3";
		examples[7] := "Hips4";
	...
	BEGIN
		...
		IF (v # NIL) & (v IS TextViews.View) THEN
			...
			PageBreak(m)
		END;
		examples[0] := "DataCloning";
		examples[1] := "Coins";
		examples[2] := "SmartPhones";
		examples[3] := "Abbey";
		examples[4] := "BeetlesMLE";
		examples[5] := "Multistage";
		examples[6] := "Hald";
		examples[7] := "Curves";
		examples[8] := "probit";
		examples[9] := "Lotka-Volterra";
		examples[10] := "Fivecompartment";
		examples[11] := "ChangePoints";
		i := 0;
		num := LEN(examples);
		WHILE i < num DO
